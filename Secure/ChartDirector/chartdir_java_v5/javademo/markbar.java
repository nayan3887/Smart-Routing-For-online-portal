...
public class markbar implements DemoModule
{
    //Name of demo program
    public String toString() { return "Bars with Marks"; }
    ...
    public void createChart(ChartViewer viewer, int index)
    {
        ...
        TextBox title = c.addTitle("Bars with Marks Demonstration", "Arial Italic",
            15);

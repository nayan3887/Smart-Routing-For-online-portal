...
public class threedbubble3 implements DemoModule
{
    //Name of demo program
    public String toString() { return "3D Bubble Chart (3)"; }
    ...
    public void createChart(ChartViewer viewer, int index)
    {
        ...
        c.addScatterLayer(dataX0, dataY0, "Technology AAA", Chart.SolidSphereShape,
        ...
        c.addScatterLayer(dataX1, dataY1, "Technology BBB", Chart.SolidSphereShape,
    ...
    public static void main(String[] args)
    {
        ...
        DemoModule demo = new threedbubble3();

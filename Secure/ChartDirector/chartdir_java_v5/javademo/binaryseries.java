...
public class binaryseries implements DemoModule
{
    //Name of demo program
    public String toString() { return "Binary Data Series"; }
    ...
    public void createChart(ChartViewer viewer, int index)
    {
        ...
        Date[] dataX = {new GregorianCalendar(2008, 6, 1, 0, 0, 0).getTime(),
            new GregorianCalendar(2008, 6, 1, 2, 17, 2).getTime(),
            new GregorianCalendar(2008, 6, 1, 8, 5, 30).getTime(),
            new GregorianCalendar(2008, 6, 1, 10, 54, 10).getTime(),
            new GregorianCalendar(2008, 6, 1, 15, 40, 0).getTime(),
            new GregorianCalendar(2008, 6, 1, 18, 22, 20).getTime(),
            new GregorianCalendar(2008, 6, 1, 22, 17, 14).getTime(),
            new GregorianCalendar(2008, 6, 2, 2, 55, 50).getTime(),
            new GregorianCalendar(2008, 6, 2, 8, 17, 14).getTime(),
            new GregorianCalendar(2008, 6, 2, 11, 55, 50).getTime(),
            new GregorianCalendar(2008, 6, 2, 13, 17, 14).getTime(),
            new GregorianCalendar(2008, 6, 2, 17, 55, 50).getTime(),
            new GregorianCalendar(2008, 6, 2, 20, 17, 14).getTime(),
        ...
        TextBox title = c.addTitle("Binary Data Series Demonstration", "Arial Bold",
            10);

        // Tentatively set the plotarea at (100, 30) and of size 470 x 120 pixels.
        // Use transparent border. Use grey (888888) solid line and light grey
        // (ccccc) dotted line as major and minor vertical grid lines.
        ...
        // Use "<*font=Arial Bold*>{value|mmm dd}" for the first label of an hour,
        // and "{value|hh:nn}" for all other labels.
        ...
        // is 10 pixels from the left edge, 10 pixels  below the title, 30 pixels
        // from the right edge, and 10 pixels above the bottom edge.
    ...
    public static void main(String[] args)
    {
        ...
        DemoModule demo = new binaryseries();

<%-- 
    Document   : delivery
    Created on : Feb 5, 2018, 5:39:57 AM
    Author     : Neena
--%>
    ...
    <body>
        <div id="container" class="container">
            ...
            <div style="border:1px solid white;width: 700px;height: 400px;margin-left: 300px;border-radius: 9px;background-image: url()"><br />
                <center><h1 style="color: white;">Welcome to Delivery Person Login</h1></center>
                <form action="deliveryaction.jsp" method="post" style="width: 600px;height: 300px;margin-left: 80px;"><br />
                    <center> 

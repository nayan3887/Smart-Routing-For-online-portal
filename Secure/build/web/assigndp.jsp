    ...
    <body>
        <div id="container" class="container">
            ...
            <div class="abstract" style="background-image: url('images/wall1.jpg')"><br />
                ...
                <center><h1 style="color: white">Assigned Delivery Person by Dynamic Routing</h1></center>
                <table style="margin-left: 50px;margin-top: -10px">
                    <tr>
                       ...
                       <th style="background-color: blue">Quantity</th>
                        ...
                        <th style="background-color: blue">User Contact</th>
                        <th style="background-color: blue">Delivery Person</th>
                        <th style="background-color: blue">DP Contact</th>
                    </tr>
                    <%
                        try {

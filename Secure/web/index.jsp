    ...
    <body>
        <div id="container" class="container">
            ...
            <div class="abstract"><br/>
                <h1 style="margin: 5px;color: white">Team :</h1><br>  
                <p style="text-align: justify;margin: 15px;font-size: 19px;margin-top: -10px;color: white">
                                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <div style=" margin-left: 200px">    <ul style="color: white">1. Karan Pardeshi </ul>       
                <ul style="color: white">2. Nayan Chaudhari</ul>     
                <ul style="color: white">3. Tejal Chaudhari</ul>       
                <ul style="color: white">4. Anjali Patil</ul>     
                </div>    </p>
            </div>
        </div> <!-- /container -->
        <div>

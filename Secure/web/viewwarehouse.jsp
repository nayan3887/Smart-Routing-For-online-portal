    ...
    <body>
        <div id="container" class="container">
            ...
            <div class="" style="background: "><br><br>
                <center><h1 style="color: white;margin-top: -10px">Warehouse Details</h1></center>
                <br><table style="margin-left: 280px;margin-top: -20px" >
                    <tr>
                        <th style="background-color: blue">Warehouse Name</th>
                        <th style="background-color: blue">Address</th>
                        <th style="background-color: blue">Opening Time</th>
                        <th style="background-color: blue">Closing Time</th>
                    ...
                    <tr>
                        ...
                        <td><a href="ddeletew.jsp?<%=rs.getString("id")%>">Remove</a></td>
                    </tr>
                    <% }
                        } catch (Exception e) {
                            e.printStackTrace();
                            System.out.println("Warehouseview product details Page" + e.getMessage());
                        }
                    %>
                </table>
            </div>

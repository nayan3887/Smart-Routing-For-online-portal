    ...
    <body>
        <div id="container" class="container">
            ...
            <div class="abstract" style="background-image: url('images/wall1.jpg')"><br />
                ...
                <center><h1 style="color: white">Shipped Products Details</h1></center>
                <table style="margin-left: 275px;margin-top: -10px">
                    ...
                    <%
                        try {
                            ...
                            ResultSet rs = st.executeQuery("select * from cart where status='SHIPPED'");
                            while (rs.next()) {
                    ...
                    <% }
                            ...
                            e.printStackTrace();
                            System.out.println("Admin shipped Page" + e.getMessage());
                        }
                    %>
                </table>
            </div>

...
private void createFirstChart(WebChartViewer viewer)
{
    ...
    viewer.setScrollDirection(Chart.DirectionHorizontalVertical);
    viewer.setZoomDirection(Chart.DirectionHorizontalVertical);
...
{
    //
    // For simplicity, in this demo, we just use hard coded data. In a real application, the data
    // may come from a dynamic source such as a database. (See "Using Data Sources with
    // ChartDirector" in the ChartDirector documentation if you need some sample code on how to read
    ...
    //
    // In this example, we represent the data by scatter points. If you want to represent the data
    // by somethings else (lines, bars, areas, floating boxes, etc), just modify the code below to
    // use the layer type of your choice.
    //
    ...
    if ((viewer.getCustomAttr("minY") == null) || (viewer.getCustomAttr("minY") == "")) {
        ...
        double minX = Double.parseDouble(viewer.getCustomAttr("minX"));
        double maxX = Double.parseDouble(viewer.getCustomAttr("maxX"));
        double minY = Double.parseDouble(viewer.getCustomAttr("minY"));
        double maxY = Double.parseDouble(viewer.getCustomAttr("maxY"));

...
public class linecompare implements DemoModule
{
    ...
    public void createChart(ChartViewer viewer, int index)
    {
        ...
        double[] curveY = {50, 44, 54, 48, 58, 50, 90, 85, 104, 82, 96, 90, 74, 52,
            35, 58, 46, 54, 48, 52, 50};
        ...
        // white (ffffff) on a black background, with a 1 pixel 3D border.
        c.addTitle(
            "<*block,valign=absmiddle*><*img=star.png*><*img=star.png*> " +
            "Performance Enhancer <*img=star.png*><*img=star.png*><*/*>",
            "Times New Roman Bold Italic", 15, 0xffffff).setBackground(0x000000, -1,
            1);
        ...
        // Add a line layer to the chart with two dark green (338033) data sets, and
